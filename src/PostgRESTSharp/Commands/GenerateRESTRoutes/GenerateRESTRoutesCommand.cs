...
namespace PostgRESTSharp.Commands.GenerateRESTRoutes
{
	...
	public class GenerateRESTRoutesCommand
	{
		...
		public void All([CommandParameter(Prototype = "d|database", Description = "The database name to generate routes for.", IsRequired = true)]string database,
            ...
            [CommandParameter(Prototype = "x|extensionsNamespace", Description = "The extentions namespace included for the generated routes.", IsRequired = true)]string extensionNamespace,
        ...
        )
		{
			...
			this.generateRESTRoutesCommandProcessor.Process(resources, splitFiles, fileName, outputDirectory, fileNamespace, modelNamespace, errorHandlingMode, extensionNamespace);
		}
	}
}

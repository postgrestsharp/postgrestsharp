...
namespace PostgRESTSharp.Commands.GenerateRAML
{
    ...
    public class GenerateRAMLCommand
    {
        ...
        public void All(
            ...
            [CommandParameter(Prototype = "a|accessRole", Description = "The role the documenation is generated for", IsRequired = true, DefaultValue = "weborigination")]string accessRole
        )
        {

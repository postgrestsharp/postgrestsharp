    ...
    public class RESTResourceProcessor : IRESTResourceProcessor
    {
        ...
        public IEnumerable<RESTResource> Process(IEnumerable<IViewMetaModel> views, bool isReadOnly)
        {
            ...
            foreach (var view in views)
            {
                ...
                var getRestModel = this.restModelBuilder.BuildRESTModel(view, RESTVerbEnum.GET, views);//here
                ...
                var resource = new RESTResource(view.ModelNamePluralised.ToLower(), view.ViewName, view.ModelName, pkCol.ColumnName, methods, roleClaims, view.SchemaName, view.IsExclused);

...
{
    public class when_transforming_a_range_header_with_a_range_greater_than_the_count_limit : WithFakes
    {
        Establish that = () =>
        {
            rangeHeaderKey = "Range";
            rangeHeaderValue = "0-1000";
        ...
        private It should_return_a_default_range = () =>
        {
            transformedHeaders
